...
const PORTFOLIO_ITEMS: PortfolioItem[] = [
  ...
  { id: 33, label: "Wedding Portrait", category: "Weddings", size: "tall" },
  { id: 9, label: "Graduation Shoot", category: "Graduations", size: "tall" },
  { id: 48, label: "Portrait Session", category: "Portraits", size: "tall" },
  ...
  { id: 34, label: "Wedding Portrait", category: "Weddings", size: "square" },
  { id: 49, label: "Portrait Session", category: "Portraits", size: "square" },
  ...
  { id: 35, label: "Wedding Portrait", category: "Weddings", size: "wide" },
  { id: 4, label: "Wedding Celebration", category: "Weddings", size: "wide" },
  { id: 12, label: "Outdoor Session", category: "Graduations", size: "tall" },
  { id: 50, label: "Portrait Session", category: "Portraits", size: "wide" },
  { id: 29, label: "Lifestyle Model Portfolio", category: "Model Shoots", size: "wide" },
  { id: 36, label: "Wedding Portrait", category: "Weddings", size: "tall" },
  { id: 25, label: "Cultural Celebration", category: "Graduations", size: "square" },
  { id: 32, label: "Professional Model Headshot", category: "Portraits", size: "tall" },
  { id: 7, label: "The Reception", category: "Weddings", size: "wide" },
  { id: 17, label: "Studio Style", category: "Graduations", size: "tall" },
  { id: 37, label: "Wedding Portrait", category: "Weddings", size: "square" },
  ...
  { id: 51, label: "Portrait Session", category: "Portraits", size: "tall" },
  { id: 38, label: "Wedding Portrait", category: "Weddings", size: "wide" },
  ...
  { id: 39, label: "Wedding Portrait", category: "Weddings", size: "tall" },
  { id: 52, label: "Portrait Session", category: "Portraits", size: "square" },
  { id: 26, label: "Ceremony Detail", category: "Graduations", size: "tall" },
  { id: 5, label: "The Couple", category: "Weddings", size: "square" },
  { id: 40, label: "Wedding Portrait", category: "Weddings", size: "square" },
  { id: 11, label: "Ceremony Moment", category: "Graduations", size: "wide" },
  { id: 47, label: "Wedding Portrait", category: "Portraits", size: "wide" },
  { id: 3, label: "Ifejesu & Victor III", category: "Weddings", size: "tall" },
  { id: 41, label: "Wedding Portrait", category: "Weddings", size: "wide" },
  { id: 18, label: "Graduation Milestone", category: "Graduations", size: "wide" },
  { id: 42, label: "Wedding Portrait", category: "Weddings", size: "tall" },
  { id: 19, label: "Portrait Session", category: "Graduations", size: "square" },
  { id: 6, label: "First Dance", category: "Weddings", size: "tall" },
  { id: 43, label: "Wedding Portrait", category: "Weddings", size: "square" },
  { id: 24, label: "Event Highlight", category: "Graduations", size: "wide" },
  { id: 44, label: "Wedding Portrait", category: "Weddings", size: "wide" },
  { id: 21, label: "Graduate Close-up", category: "Graduations", size: "square" },
  { id: 45, label: "Wedding Portrait", category: "Weddings", size: "tall" },
  { id: 13, label: "Graduation Celebration", category: "Graduations", size: "square" },
  { id: 46, label: "Wedding Portrait", category: "Weddings", size: "square" },
